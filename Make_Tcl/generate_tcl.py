...
#### PARAMETERS
parser.add_argument('-K','--perm',type=float, default = 0.02849, help='Permeability (optional). Default is 0.02849 (i.e. average K of the Upper Colorado basin)', required=False)
...
parser.add_argument('-ts','--timestep',type=float, default = 0.1, help='Constant time step (optional). Default is 0.1', required=False)
parser.add_argument('--dump',type=float, default = -1.0, help='Dump interval (optional). Default is -1', required=False)
...
parser.add_argument('--dz_scales',nargs='+', help='dz scale to be multiplied with dz (optional). Default is 0.5', required=False)
...
#get batch name
batch_dict = {0:'land',1:'ocean',2:'land',3:'top',4:'lake',5:'sink',6:'bottom'}
