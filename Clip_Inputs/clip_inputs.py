...
parser = argparse.ArgumentParser(description='Create a clipped input ParFlow '
                                             'binary files')
parser.add_argument('-i', '--input_file', type=str,
                    help='input file for subsetting')
parser.add_argument('--crop_to_domain', type=int,
                    help='crop to domain (i.e. value outside of the domain '
                         'will be assign as nodata -- optional).Default is 1')
...
parser_a.add_argument('-att', type=str, required=False, default='OBJECTID',
                      help='Column name of the shape attribute to use during'
                           'during rasterize')
...
parser_c = subparsers.add_parser('define_watershed',
                                 help='subset using a newly created watershed')
...
if args.type == 'shapefile':
    ...
    avra_path_shp = '/iplant/home/shared/avra/CONUS_1.0/SteadyState_Final/' + \
                    'Subdomain_Extraction/Shape_Files/Regions_shp/'
    ...
    if not os.path.isfile(dir_file):
        ...
        avra_path_direction = '/iplant/home/shared/avra/CONUS2.0/Inputs/' + \
                              'Topography/Str5Ep0/'
