...
#Converting sa to pfb and silo
set   slopex  [pfload -sa $out_name.sa]
pfsetgrid {$ncol $nrow $dim} {0.0 0.0 0.0} {1000.0 1000.0 1000.0} $slopex
pfsave $slopex -silo $out_name.silo
pfsave $slopex -pfb  $out_name.pfb
